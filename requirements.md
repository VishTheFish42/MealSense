...
- ❌ No CI/CD pipeline (tasks.md 7.4 — no longer blocked on "no remote", since the repo has had one all session; still not built)
...
| Deployment | 🟡 backend live on Cloud Run + app pointed at it; no CI/CD or env separation yet |
