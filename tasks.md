...
- [ ] 8.2 Instrument: profile completion, time-to-recommendation, order conversion (recommendation relevance itself is now captured via 8.0's thumbs-up/down — this item is the remaining signals)
